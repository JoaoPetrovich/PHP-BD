...
-- estado(IDESTADO,SIGLA,NOME,DTINSERT,HRINSERT,DTUPDATE,HRUPDATE)
CREATE TABLE estado
	(
...
-- bkpestado(IDBKPESTADO,IDESTADO,SIGLA,NOME,DTINSERT,HRINSERT,DTUPDATE,HRUPDATE,DTBKP,HRBKP)
...
-- marca(IDMARCA,NOME,PRODUTOS,DTINSERT,HRINSERT,DTUPDATE,HRUPDATE)
CREATE TABLE marca
(
...
-- bkpmarca(IDBKPMARCA,IDMARCA,NOME,PRODUTOS,,HRINSERT,DTUPDATE,HRUPDATE,DTBKP,HRBKP)
...
-- unidade(IDUNIDADE,NOME,PRODUTOS,DTINSERT,HRINSERT,DTUPDATE,HRUPDATE)
...
-- bkpunidade(IDBKPUNIDADE,IDUNIDADE,NOME,PRODUTOS,,HRINSERT,DTUPDATE,HRUPDATE,DTBKP,HRBKP)
